...
export type Alert =
  | { kind: 'campaign'; title: string; message: string; href: string; cta: string }
  | { kind: 'gmv-behind'; title: string; message: string; href: string; cta: string }
  | { kind: 'papaya-pick'; title: string; message: string; href: string; cta: string }
