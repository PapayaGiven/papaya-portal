...
export default function ApplicationForm({ campaignId }: { campaignId: string }) {
  ...
  if (submitted) {
    return (
      <div className="text-center py-6">
        ...
        <h3 className="font-playfair text-xl text-brand-black mb-1">Bewerbung erhalten!</h3>
        <p className="font-dm-sans text-sm text-gray-500">Wir melden uns bei dir, sobald wir deine Bewerbung geprüft haben.</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      >
        {isPending ? 'Senden...' : 'Bewerbung senden →'}
      </button>
    </form>
  )
}
