      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {linkedProducts.length > 0 && (
          <div className="bg-white rounded-3xl border border-brand-pink/20 shadow-sm p-6 mb-6">
            <h2 className="font-playfair text-xl text-brand-black mb-4">Verlinkte Produkte</h2>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {p.commission_rate != null && (
                      <p className="font-dm-sans text-xs text-brand-pink font-bold">{p.commission_rate}% Provision</p>
                    )}
                  </div>
                </a>
              ))}
