      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-sm border border-brand-pink/20 p-10">
          <div className="text-center mb-8">
            ...
            <p className="font-dm-sans text-xs font-semibold text-white px-3 py-1 rounded-full inline-block mb-3" style={{ backgroundColor: '#1B5E3B' }}>Papaya Social Club — Deutschland 🇩🇪</p>
            <h1 className="font-playfair text-4xl text-brand-green leading-tight">
              {mode === 'login' ? 'Willkommen zurück.' : 'Hallo!'}
            </h1>
            <p className="font-dm-sans text-gray-500 mt-2 text-sm">
              {mode === 'login' ? 'Dein Dashboard wartet auf dich.' : 'Wie möchtest du fortfahren?'}
            </p>
          </div>
